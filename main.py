...
def main():
    ...
    st.set_page_config(page_title="인성 교육", page_icon="❤️", layout="centered")  # 레이아웃을 설정하여 폰트 경고를 방지
    st.image('Elementary Classroom.png')  # 상단에 이미지를 표시
    st.title("_:red[선생님의 인성 교육 도우미]_ 🏫")  # 제목 표시 (선생님의 인성 교육 도우미)
